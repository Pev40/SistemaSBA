...
<div class="form-group date" data-provide="datepicker" >
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="number" class="form-control" name="monto" style="width:100px" value="25">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-4 control-label">Cantidad</label>
		<div class="col-sm-8">
			<input type="number" class="form-control" name="cant" style="width:100px" value="1">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-4 control-label">Total</label>
		<div class="col-sm-8">
			<input type="number" class="form-control" name="total" style="width:100px" value="25" disabled="disabled">
		</div>
	</div>
	<!--<div class="form-group">
		<label class="col-sm-4 control-label">Serie</label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="serie" style="width:100px" disabled="disabled" value="B012">
		</div>
	</div>
	<div class="form-group">
    ...
    <div class="form-group" name="gridTicket">
