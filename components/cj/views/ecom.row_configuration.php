        ...
        <table class="table table-bordered" name="grid">
            <thead>
                ...
                <tr>
                    <th colspan="4">
                        ...
                        <input disabled style="width:100%" type="text" name="descripcion_item" class="input-lg form-control"></input>
                    </th>
                </tr>
                <tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <td><input disabled type="text" name="valor_unitario" class="form-control"></td>
                </tr>
                <tr>
                    <td colspan="3">Cantidad</td>
                    <td><input disabled type="text" name="cantidad" class="form-control"></td>
                </tr>
                <tr>
                    <td colspan="3">Unidad</td>
                    <td><select disabled name="unidad" class="form-control">
                ...
                <tr>
                    ...
                    <td><select disabled name="tipo_igv" class="form-control">
                ...
                <tr>
                    ...
                    <td><input disabled type="text" name="igv" class="form-control"></td>
                </tr>
                <tr>
                    <td colspan="3">Precio de venta unitario</td>
                    <td><input disabled type="text" name="precio_venta_unitario" class="form-control"></td>
                </tr>
                <tr>
                    <td colspan="3">Precio de total</td>
                    <td><input disabled type="text" name="precio_total" class="form-control"></td>
                </tr>
            </tfoot>
        </table>
    </div>
