...
if(!class_exists('invoiceRepresenttationA4')){
	class invoiceRepresenttationA4 extends FPDF{
		...
		function Footer(){
			...
			$this->setXY(0,$y);$this->MultiCell(75,4,"Representación impresa de la ".$tipo[$this->data['tipo']].", para consultar el documento visita https://see.conflux.pe/search",'0','C');
			$y=$this->getY();
