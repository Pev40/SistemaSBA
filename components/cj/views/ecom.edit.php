...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group"><label>Fecha de emision:</label> <input type="text" class="form-control" name="fecemi" ></div>
            </div>
            <div class="col-sm-4">
                <div class="form-group"><label>Fecha de vencimiento:</label> <input type="text" class="form-control" name="fecven" ></div>
            </div>
            <div class="col-sm-4">
    ...
    <table class="table invoice-table" name="grid">
        ...
        <tfoot style="display:none">
            <tr id="rowReference">
                ...
                <td><input style="width:100%" type="text" name="descripcion" class="input-lg form-control" disabled></input></td>
                <td>
                    ...
                    <select class="input-lg form-control" name="unidad" disabled>
