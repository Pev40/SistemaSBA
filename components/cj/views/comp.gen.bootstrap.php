<fieldset>
	...
	<div class="row">
		...
		<div class="col-sm-6" name="div_inm">
			<div class="input-group">
				<span class="input-group-addon">Tipo de Recibo</span>
				<select class="form-control" name="tipo_inm">
					...
					<option value="TDM">Taller de Maria</option>
					<option value="CMC">Cementerio - Recorrido</option>
				</select>
			</div>
		</div>
	</div>
