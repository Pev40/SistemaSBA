...
<ul style="display: block;" class="nav" id="side-menu">
	...
	<?php if (isset($f->session->tasks['re'])) { ?>
		<li>
			<a name="rp">
				...
				<span class="nav-label">Reportes Generales SBA</span>
				<span class="fa arrow"></span>
			</a>
			<ul class="nav nav-second-level collapse in">

				<li><a name="rpRepo"><i class="fa fa-line-chart"></i> Reportes</a></li>


				<li><a name="rpDash"><i class="fa fa-line-chart"></i> Dashboard</a></li>

				<li><a name="rpPosc"><i class="fa fa-line-chart"></i> Configuraci&oacute;n de POS</a></li>
			</ul>
	...
	<?php if(isset($f->session->tasks['po'])){ ?>
	 <li>
        ...
        <ul class="nav nav-second-level collapse in">
			<?php //if(isset($f->session->tasks['po.visi'])){ ?>
	...
	<?php if(isset($f->session->tasks['in'])){ ?>
	 <li>
        ...
        <ul class="nav nav-second-level collapse in">
				<?php if (isset($f->session->tasks['in.rent'])) { ?>
				...
				<?php } ?>
				<?php if (isset($f->session->tasks['in.comp'])) { ?>
				...
				<?php } ?>
				<?php if (isset($f->session->tasks['in.reps'])) { ?>
