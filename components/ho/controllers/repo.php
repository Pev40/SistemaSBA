<?php
class Controller_ho_repo extends Controller {
	function execute_index(){
		global $f;
		$f->response->view('ho/repo');
	}
	function execute_hospitalizaciones(){
		global $f;
		$data = $f->model('ho/hosp')->params(array(
		...
		if($f->request->data['type']=='xls'){
			$f->response->view("ho/repo.hospitalizaciones.xls",array(
				'data'=>$data,'params'=>$f->request->data
			));
		}elseif($f->request->data['type']=='pdf'){
			$f->response->view("ho/repo.hospitalizaciones.pdf",array(
				'data'=>$data,'params'=>$f->request->data
			));
		}
	}
	function execute_estado_cuenta_hospitalizaciones(){
		global $f;
		$data = $f->model('ho/hosp')->params(array(
			'histcli'=>$f->request->data['histcli'],
		))->get('all_by_histcli')->items;
		if($f->request->data['type']=='pdf'){
			$f->response->view("ho/repo.estado.cuenta.hospitalizaciones.pdf",array(
				'data'=>$data,'params'=>$f->request->data
			));
		}
	}
	...
	function execute_altas(){
		...
		if($f->request->data['type']=='xls'){
			$f->response->view("ho/repo.altas.xls",array(
				'data'=>$data,'params'=>$f->request->data
			));
		}elseif($f->request->data['type']=='pdf'){
			$f->response->view("ho/repo.altas.pdf",array(
				'data'=>$data,'params'=>$f->request->data
			));
		}
	}
	function execute_registro_ventas_lm(){
		global $f;
		...
		if($f->request->data['type']=='xls'){
			$f->response->view("ho/repo.registro_ventas.xls",array(
				'data'=>$comp,'params'=>$f->request->data
			));
		}elseif($f->request->data['type']=='pdf'){
			$f->response->view("ho/repo.registro_ventas.pdf",array(
				'data'=>$comp,'params'=>$f->request->data
			));
		}
	}
