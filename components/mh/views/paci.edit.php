	...
	<div class="form-group" name="gridCli" >
		<label class="col-sm-4 control-label">Historia Clinica: </label>
			<div class="col-sm-8 input-group">
				<input type="text" class="form-control" name="his_Cli" disabled="disabled"  style="width:300px" required >
			</div>
	</div>
		...
		<label class="col-sm-4 control-label">Categoria</label>
			<div class="col-sm-8">
				<select class="form-control" name="categoria" type = "text" style="width:300px" required>
					...
					<option value="9">Categoria P</option>
					<option value="11">Tarifa General</option>
					<option value="8">Caso Social Indigente</option>
				</select>
			</div>
	</div>
